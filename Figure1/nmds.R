...
#
# 分组列名"-o", "--output"，输出目录，默认同输入+.nmds.pdf；
#
...
# 设置输出文件缺省值，如果为空，则为输入+nmds.pdf
if(opts$output==""){opts$output=paste0(opts$input,".nmds.pdf")}
...
plot(nmds$points,col=sample_colors,pch=19,cex=2,
